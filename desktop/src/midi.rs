/// MIDI input watcher using midir (ALSA backend).
///
/// Polls the port list every 2 seconds.  Connects automatically when a device
/// appears and reconnects if it is unplugged and re-plugged.
